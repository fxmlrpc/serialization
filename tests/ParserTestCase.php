...
abstract class ParserTestCase extends \PHPUnit_Framework_TestCase
{
    ...
    public function testParsingListResponse()
    {
        ...
        $this->assertFalse($isFault);
        $this->assertSame(['Str 0', 'Str 1'], $result);
    ...
    public function testParsingListsInStructs()
    {
        ...
        $this->assertSame(
            [
                'FIRST'  => [[' Str 00', ' Str 01'], [' Str 10', ' Str 11']],
                'SECOND' => [['Str 30', 'Str 31'], ['Str 40', 'Str 41']],
            ],
            $this->parser->parse($string, $isFault)
        );
        $this->assertFalse($isFault);
    ...
    public function testEmptyStruct_1()
    {
        ...
        $isFault = true;
        $this->assertSame([], $this->parser->parse($string, $isFault));
        $this->assertFalse($isFault);
    }
    ...
    public function testEmptyStructMember()
    {
        ...
        $isFault = false;
        $this->assertSame(['FIRST' => ''], $this->parser->parse($string, $isFault));
        $this->assertFalse($isFault);
    }
}
